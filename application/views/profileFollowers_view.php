...
<body>
	...
	<div class="filter clearfix" id="profile">
		...
		<a href="http://ajweb.be/brainstorm/index.php/profile/followers/<?php foreach($rows as $r) : ?><?php echo $r->PK_User_ID ?><?php endforeach; ?>" class="filter-button active" id="followers-button"><span>Followers</span></a>
	</div>
